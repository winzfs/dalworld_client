...
export const BUILD_PARTS: Record<BuildPartId, BuildPartDefinition> = {
  ...
  wood_stair_landing: common("wood_stair_landing", "나무 계단참", "floor", "tile", "▣", false, true, FLOOR_SUPPORTS, [{ itemId: "wood", quantity: 2 }]),
  stone_stair_landing: common("stone_stair_landing", "돌 계단참", "floor", "tile", "▣", false, true, FLOOR_SUPPORTS, [{ itemId: "stone", quantity: 2 }]),
  ...
  wood_corner_stairs: common("wood_corner_stairs", "나무 ㄱ자 계단", "floor", "corner", "◰", false, true, STAIR_SUPPORTS, [{ itemId: "wood", quantity: 4 }]),
  stone_corner_stairs: common("stone_corner_stairs", "돌 ㄱ자 계단", "floor", "corner", "◲", false, true, STAIR_SUPPORTS, [{ itemId: "stone", quantity: 5 }]),
  ...
  wood_beam_horizontal: common("wood_beam_horizontal", "나무 가로 보", "support", "edge", "═", true, true, WALL_SUPPORTS, [{ itemId: "wood", quantity: 2 }]),
  stone_beam_horizontal: common("stone_beam_horizontal", "돌 가로 보", "support", "edge", "═", true, true, WALL_SUPPORTS, [{ itemId: "stone", quantity: 3 }]),
  wood_diagonal_support: common("wood_diagonal_support", "나무 대각 보강재", "support", "edge", "╱", true, true, WALL_SUPPORTS, [{ itemId: "wood", quantity: 1 }]),
  stone_diagonal_support: common("stone_diagonal_support", "돌 대각 보강재", "support", "edge", "╱", true, true, WALL_SUPPORTS, [{ itemId: "stone", quantity: 2 }]),
  ...
  wood_roof_corner: common("wood_roof_corner", "나무 지붕 코너", "roof", "corner", "◫", true, true, WALL_SUPPORTS, [{ itemId: "wood", quantity: 3 }]),
  stone_roof_corner: common("stone_roof_corner", "돌 지붕 코너", "roof", "corner", "◫", true, true, WALL_SUPPORTS, [{ itemId: "stone", quantity: 4 }]),
  thatch_roof_corner: common("thatch_roof_corner", "초가 지붕 코너", "roof", "corner", "◫", true, true, WALL_SUPPORTS, [{ itemId: "wood", quantity: 2 }]),
  wood_roof_ridge: common("wood_roof_ridge", "나무 지붕 마루", "roof", "edge", "▔", true, true, WALL_SUPPORTS, [{ itemId: "wood", quantity: 1 }]),
  stone_roof_ridge: common("stone_roof_ridge", "돌 지붕 마루", "roof", "edge", "▔", true, true, WALL_SUPPORTS, [{ itemId: "stone", quantity: 2 }]),
  thatch_roof_ridge: common("thatch_roof_ridge", "초가 지붕 마루", "roof", "edge", "▔", true, true, WALL_SUPPORTS, [{ itemId: "wood", quantity: 1 }]),
